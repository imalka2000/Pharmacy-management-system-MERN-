                        ...
                        <Row className="g-4 mb-4">
                            <Col lg={4}>
                                <div className="border border-2 border-dashed rounded-5 p-4 text-center bg-light position-relative overflow-hidden h-100 d-flex align-items-center justify-content-center transition shadow-inner">
                                    ...
                                    {formData.imageUrl ? (
                                        <img src={formData.imageUrl.startsWith('http') ? formData.imageUrl : `http://localhost:5000${formData.imageUrl}`} className="img-fluid rounded-4 shadow-sm" style={{ maxHeight: '180px' }} alt="Preview" />
                                    ) : (
                                        <div className="py-2">
